...
export default function Hero() {
  ...
  return (
    <div className='bg-white flex justify-between items-center pt-[93px] pl-[60px] pb-[74px] relative'>
        ...
        <button
          ...
          <svg 
              ...
              <g clip-path="url(#clip0_2_2655)">
                  <path d="M10.7812 7.33312L7.20517 3.75712L8.14784 2.81445L13.3332 7.99979L8.14784 13.1851L7.20517 12.2425L10.7812 8.66645H2.6665V7.33312H10.7812Z" fill="#fff"/> {/* Icon color */}
              </g>
              <defs>
