...
function Newsletter() {
  ...
  return (
    <div>
      <section class=" xl:max-w-6xl w-[90%] mx-auto bg-gray-900 mt-12">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          <div class="mx-auto max-w-screen-md sm:text-center">
            <h2 class="mb-4 text-3xl tracking-tight font-extrabold text-white">
              Sign up for our newsletter
            </h2>
            <p class="mx-auto mb-8 max-w-2xl font-light text-gray-200 md:mb-12 sm:text-xl dark:text-gray-400">
