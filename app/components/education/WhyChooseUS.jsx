...
export default function WhyChooseUS() {
  return (
    <div id="learn-more" className="bg-[#0f172a] mt-24">
      <section
        id="features"
      ...
      >
        <div className="relative mx-auto max-w-5xl text-center">
          ...
          <p className="mx-auto my-4 w-full max-w-xl bg-transparent text-center font-medium leading-relaxed tracking-wide text-gray-400">
            Choose Lyzerslab and unlock the potential to bring your digital
            vision to life with excellence and ease.
          </p>
        </div>
        ...
        <div className="relative mx-auto max-w-7xl z-10 grid grid-cols-1 gap-10 pt-14 sm:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-md border border-neutral-800 bg-neutral-900/50 p-8 text-center shadow">
            <div
              className="button-text mx-auto flex h-12 w-12 p-3 items-center justify-center rounded-md border"
              style={{
                backgroundImage: "linear-gradient(#fff 0%, #d9e4fb17 100%)",
              }}
            >
            ...
            <h3 className="mt-6 text-xl text-gray-200 font-semibold">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(to left top, #f5e0f41c 0%, transparent 50%, transparent 100%)",
            borderColor: "rgba(92, 79, 240, 0.2)",
          }}
        ></div>
      </section>
